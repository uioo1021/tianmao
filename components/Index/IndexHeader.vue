...
<div class="header">
    <div class="header-div">
        <div class="header-left">
            ...
            <a href="/register" target="_blank" class="header-a-second">免费注册</a>
            ...
            <div v-for="item in headerData?.data" :key="item.name" class="group header-right-div">
                <div class="header-right-item">
                    <div v-if="item.isIcon" class="flex"> 
                        <component v-if="item.component === 'Shopping'" class="header-right-icon text-[rgb(255,0,54)]" :is="getIconComponent(item.component)" />
...
import { headerData } from '~/data/index/headerData.js'
...
.header-left-div{
    @apply flex ml-4 hover:text-[rgb(255,0,54)];
}
.header-a-first{
    @apply flex  text-[rgb(255,0,54)];
}
.header-a-second{
    @apply flex ml-2 hover:text-[rgb(255,0,54)];
}
.header-right-div{
    @apply relative flex hover:text-[rgb(255,0,54)];
}
.header-right-icon{
    @apply flex w-4 h-4;
}
